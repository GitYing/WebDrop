<template>
  <div class="about">
    <div class="container">
      <div class="content">
        <h3 class="is-size-3">ip2.quest</h3>
      ...
      <b-tabs v-model="tab" expanded>
        <b-tab-item label="Help" class="content">
          ...
          <ol>
            ...
            <li>Open this website (ip2.quest) on your devices</li>
          ...
          <p>Go to <router-link to="/settings">settings</router-link> to configure ip2.quest to your needs.</p>
          ...
          <ul>
            ...
            <p><span style="display: inline-block;vertical-align: top;"><b>Ans:</b>&nbsp;Click the "globe" icon</span>&nbsp;<span style="display: inline-block;vertical-align: bottom;"><earth-icon></earth-icon></span>&nbsp;<span style="vertical-align: top;">on navbar, share the room code or invite link with your friends. Once your friends join your room, you can share files with them. Remember, you'll have to keep ip2.quest open until transfer is complete.</span></p>
